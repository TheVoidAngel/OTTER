...
int main() {
	...
	///
	static const GLfloat pointsTable[] = { 
		-0.5f, 0.0f, 0.0f,
		0.5f, 0.0f, 0.0f,
		-0.5f, 1.0f, 0.0f
	};

	static const GLfloat colorsTable[] = { 
		0.0f, 0.5f, 1.0f,
		2.0f, 1.0f, 0.0f,
		1.0f, 0.0f, 0.5f
	};
	...
	posVbo2->LoadData(pointsTable, 9); 

	VertexBuffer::Sptr color_vbo2 = VertexBuffer::Create();
	color_vbo2->LoadData(colorsTable, 9); 
	...
	camera->SetPosition(glm::vec3(2, 1, 2));
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform3 += glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(0, 7, 1));
